...
public class RunWordle implements Runnable {
    public void run() {
        ...
        final JLabel status = new JLabel("Wordle");
        ...
        final JButton reset = new JButton("Reset and Instructions");
        ...
        reset.addActionListener(e -> JOptionPane.showMessageDialog(frame, board.instructions()));
